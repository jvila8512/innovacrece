...
import { getEntity as getReto } from '../reto/reto.reducer';
import ComponenteIdea1 from './componenteIdea1';
import { getEntities as getTipoNotificaciones } from 'app/entities/tipo-notificacion/tipo-notificacion.reducer';
import { getEntity } from 'app/entities/reto/reto.reducer';

const vistaIdeasReto1 = props => {
      ...
      <div className="col-12  sm:col-12 md:col-12 lg:col-8 xl:col-12 p-2">
        <div className=" p-4 border-round-xl shadow-4 mb-2">
          <div className="flex flex-column justify-content-center align-items-center gap-3 py-5">
            <Link to={`/entidad/idea/ver_Ideas/${idea.id}/${props.retoid}/${props.index}`} id="jh-tre1" data-cy="ideasReto">
              <img
          ...
          {ideasList.map((idea1, i) =>
            idea1.publica || idea1.user?.id === props.usuario?.id || props.usuario?.id === props.reto?.user?.id ? (
              <ComponenteIdea1
                ...
                idReto={props.retoid}
                idea={idea1}
                retouser={props.retoEntity?.user}
                reto={retoEntity}
                idecosistema={props.idecosistema}
                index={props.index}
...
export default vistaIdeasReto1;
