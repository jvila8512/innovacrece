...
const noticiasVistaGrid = (props: RouteComponentProps<{ id: any; idecosistema: string; index: string }>) => {
  ...
  const atras = () => {
    props.history.push(`/entidad/noticias/grid-noticias/${props.match.params.idecosistema}/${props.match.params.index}`);
  };
          ...
          <div className="col-12 md:col-6">
            <div className="flex p-4 sm:justify-content-center text-center md:text-left flex align-items-center ">
              <section className="flex flex-column">
                <h1 className="text-6xl font-bold text-gray-900 line-height-2 mt-2">
...
export default noticiasVistaGrid;
