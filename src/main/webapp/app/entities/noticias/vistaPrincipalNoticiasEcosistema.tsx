...
import { getNoticiasByEcosistemaId, getNoticiasByPublicabyEcosistemaIdbyUserId_Paginado, reset } from './noticias.reducer';
import { APP_LOCAL_DATE_FORMAT } from 'app/config/constants';
import { FontAwesomeIcon } from '@fortawesome/react-fontawesome';
import { Alert, Button } from 'reactstrap';
import SpinnerCar from '../loader/spinner';

const VistaPrincipalNoticia = props => {
...
export default VistaPrincipalNoticia;
