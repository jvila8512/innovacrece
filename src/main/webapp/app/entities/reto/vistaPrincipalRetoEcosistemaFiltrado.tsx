...
import { getEntitiesByEcosistema1, getEntitiesByEcosistemabyIdUser, reset } from './reto.reducer';
...
const VistaPrincipalFiltrado = props => {
...
export default VistaPrincipalFiltrado;
