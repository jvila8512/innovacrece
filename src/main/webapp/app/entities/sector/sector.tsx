    ...
    <div>
      <h2 id="sector-heading" data-cy="SectorHeading">
        ...
        <div className="d-flex justify-content-end">
          ...
          <Link to="/sector/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
        ...
        {sectorList && sectorList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th>
                  <Translate contentKey="jhipsterApp.sector.id">ID</Translate>
                </th>
                <th>
            ...
            <tbody>
              {sectorList.map((sector, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  <td>
                    <Button tag={Link} to={`/sector/${sector.id}`} color="link" size="sm">
                      {sector.id}
                    </Button>
                  </td>
                  <td>{sector.sector}</td>
                  <td className="text-end">
                    <div className="btn-group flex-btn-group-container">
                      <Button tag={Link} to={`/sector/${sector.id}`} color="info" size="sm" data-cy="entityDetailsButton">
                        <FontAwesomeIcon icon="eye" />{' '}
                        <span className="d-none d-md-inline">
                          <Translate contentKey="entity.action.view">View</Translate>
                        </span>
                      </Button>
                      <Button tag={Link} to={`/sector/${sector.id}/edit`} color="primary" size="sm" data-cy="entityEditButton">
                        <FontAwesomeIcon icon="pencil-alt" />{' '}
                        <span className="d-none d-md-inline">
                          <Translate contentKey="entity.action.edit">Edit</Translate>
                        </span>
                      </Button>
                      <Button tag={Link} to={`/sector/${sector.id}/delete`} color="danger" size="sm" data-cy="entityDeleteButton">
