        ...
        {tipoContactoList && tipoContactoList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th>
                  <Translate contentKey="jhipsterApp.tipoContacto.id">ID</Translate>
                </th>
                <th>
            ...
            <tbody>
              {tipoContactoList.map((tipoContacto, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  <td>
                    <Button tag={Link} to={`/tipo-contacto/${tipoContacto.id}`} color="link" size="sm">
                      {tipoContacto.id}
                    </Button>
                  </td>
                  ...
                  <td className="text-end">
                    <div className="btn-group flex-btn-group-container">
                      <Button
                        tag={Link}
                        to={`/nomencladores/tipo-contacto/${tipoContacto.id}`}
                        color="info"
                        size="sm"
